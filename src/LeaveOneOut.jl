module LeaveOneOut
    ...
    export loo, psis_loo, PsisLoo, Loo, AbstractLoo, LooMethod, PSIS

    const LOO_METHODS = [PSIS]
    
    
    function loo(args...; method::LooMethod=PSIS(), kwargs...)
    ...
    function psis_loo(log_likelihood::ArrayType;
        ...
        ev_se = (var(pointwise_ev; mean=ev) / data_size + mean(pointwise_mcvar ./ ess)) |> sqrt
